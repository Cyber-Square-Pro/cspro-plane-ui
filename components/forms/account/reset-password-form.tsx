...
/*
  ...
  Purpose: Form component for the Reset Password page (accessed via emailed link).
           Collects new password and confirmation, with show/hide toggles.
  Props:
    - onFormSubmit: callback fired with validated password data
...
export const ResetPasswordForm: React.FC<Props> = ({
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-5" autoComplete="off">
      {/* New password */}
      <div>
