...
const ToggleSwitch: React.FC<IToggleSwitchProps> = (props) => {
  const { value, label, size = "sm", disabled, className } = props;
  ...
  return (
    <Switch
      ...
      } flex-shrink-0 cursor-pointer rounded-full border border-slate-200 transition-colors duration-200 ease-in-out focus:outline-none ${
        value ? "bg-blue-700" : "bg-gray-700"
