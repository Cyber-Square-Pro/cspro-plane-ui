...
/*
  ...
  Modified: Tysha Daniels on April 18, 2025 — added Reset Password section
  Purpose: Display security/password settings under profile. 
           Users can either change their current password directly, 
           or request a password-reset email if they've forgotten it.
  Props: None 
*/
